...
class SemCostMapConfig:
    ...
    ground_height: Optional[
        float
    ] = -0.5  # None for matterport  -0.5 for carla  -1.0 for nomoko
...
class GeneralCostMapConfig:
    ...
    # map parameters
    clear_dist: float = 0.1  # cost map expansion over the point cloud space (prevent paths to go out of the map)
